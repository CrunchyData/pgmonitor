 ...
 * For replicas, if the pg_hba.conf is necessarily different from the primary, a known good hash of that replica's
    settings can be sent as an argument to the checksum function. Views are provided to easily obtain the hash values used by this monitoring tool.
...
-- These objects were dropped in 5.3.0. Make sure they're gone
